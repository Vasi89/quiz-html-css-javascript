...
document.getElementById("homeButton").onclick = function () {
  location.href = "https://vasih.altervista.org/quizhtmlcssjs/index.html";
};
let questionCounter;
let score;
...
function loadFromFile() {
  ...
  xhr.open("GET", "quizhtmlquestions.json", false);
...
displayResults = () => {
  ...
  modalBody.innerText = `Il tuo punteggio e : ${score}`;
  modal.show();
  acceptingAnswers = false;
};
